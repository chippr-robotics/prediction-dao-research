...
**Input**: Design documents from `specs/081-coinbase-onramp/`
...
- [X] T022 [P] Add the CLAUDE.md guardrail bullet for spec 081 (optional wallet-sheet-only onramp, no Trade integration, config-off ⇒ zero UI, gateway-only secrets) in `CLAUDE.md`
