...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener } from "../common.js"
  ...
  export interface PrimeMappingInterface extends Interface {
  ...
  export interface PrimeMapping extends BaseContract {
    
    connect(runner?: ContractRunner | null): PrimeMapping;
    waitForDeployment(): Promise<this>;

    interface: PrimeMappingInterface;
