...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener } from "../common.js"
  ...
  export interface RSAAccumulatorInterface extends Interface {
  ...
  export interface RSAAccumulator extends BaseContract {
    
    connect(runner?: ContractRunner | null): RSAAccumulator;
    waitForDeployment(): Promise<this>;

    interface: RSAAccumulatorInterface;
