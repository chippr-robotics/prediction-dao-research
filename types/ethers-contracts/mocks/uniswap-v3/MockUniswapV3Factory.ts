...
decodeFunctionResult(functionFragment: 'setOwner', data: BytesLike): Result;
    ...
    export namespace FeeAmountEnabledEvent {
      ...
      export interface OutputObject {fee: bigint, tickSpacing: bigint };
    ...
    export namespace PoolCreatedEvent {
      export type InputTuple = [token0: AddressLike, token1: AddressLike, fee: BigNumberish, tickSpacing: BigNumberish, pool: AddressLike];
      export type OutputTuple = [token0: string, token1: string, fee: bigint, tickSpacing: bigint, pool: string];
      export interface OutputObject {token0: string, token1: string, fee: bigint, tickSpacing: bigint, pool: string };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
...
getFunction(nameOrSignature: 'enableFeeAmount'): TypedContractMethod<
      ...
      'nonpayable'
    >;
getFunction(nameOrSignature: 'feeAmountTickSpacing'): TypedContractMethod<
      [arg0: BigNumberish, ],
      [bigint],
      'view'
    >;
