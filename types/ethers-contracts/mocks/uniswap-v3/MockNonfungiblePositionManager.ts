...
export declare namespace INonfungiblePositionManager {
  ...
  export interface MockNonfungiblePositionManagerInterface extends Interface {
    getFunction(nameOrSignature: "burn" | "collect" | "decreaseLiquidity" | "factory" | "increaseLiquidity" | "mint" | "positions"): FunctionFragment;

    getEvent(nameOrSignatureOrTopic: "Collect" | "DecreaseLiquidity" | "IncreaseLiquidity"): EventFragment;
...
decodeFunctionResult(functionFragment: 'positions', data: BytesLike): Result;
    ...
    export namespace CollectEvent {
      export type InputTuple = [tokenId: BigNumberish, recipient: AddressLike, amount0: BigNumberish, amount1: BigNumberish];
      export type OutputTuple = [tokenId: bigint, recipient: string, amount0: bigint, amount1: bigint];
      export interface OutputObject {tokenId: bigint, recipient: string, amount0: bigint, amount1: bigint };
    ...
    export namespace DecreaseLiquidityEvent {
      export type InputTuple = [tokenId: BigNumberish, liquidity: BigNumberish, amount0: BigNumberish, amount1: BigNumberish];
      export type OutputTuple = [tokenId: bigint, liquidity: bigint, amount0: bigint, amount1: bigint];
      export interface OutputObject {tokenId: bigint, liquidity: bigint, amount0: bigint, amount1: bigint };
      export type Event = TypedContractEvent<InputTuple, OutputTuple, OutputObject>
      export type Filter = TypedDeferredTopicFilter<Event>
      export type Log = TypedEventLog<Event>
      export type LogDescription = TypedLogDescription<Event>
...
getEvent(key: 'IncreaseLiquidity'): TypedContractEvent<IncreaseLiquidityEvent.InputTuple, IncreaseLiquidityEvent.OutputTuple, IncreaseLiquidityEvent.OutputObject>;
    ...
    filters: {
      ...
      'Collect(uint256,address,uint256,uint256)': TypedContractEvent<CollectEvent.InputTuple, CollectEvent.OutputTuple, CollectEvent.OutputObject>;
