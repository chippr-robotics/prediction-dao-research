...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedLogDescription, TypedListener, TypedContractMethod } from "../../common.js"
  ...
  export interface ERC721BurnableImplInterface extends Interface {
    getFunction(nameOrSignature: "approve" | "balanceOf" | "burn" | "getApproved" | "initialize" | "isApprovedForAll" | "mint" | "name" | "owner" | "ownerOf" | "renounceOwnership" | "safeTransferFrom(address,address,uint256)" | "safeTransferFrom(address,address,uint256,bytes)" | "setApprovalForAll" | "supportsInterface" | "symbol" | "tokenURI" | "transferFrom" | "transferOwnership"): FunctionFragment;
...
decodeFunctionResult(functionFragment: 'transferOwnership', data: BytesLike): Result;
  ...
  export interface ERC721BurnableImpl extends BaseContract {
    
    connect(runner?: ContractRunner | null): ERC721BurnableImpl;
    waitForDeployment(): Promise<this>;

    interface: ERC721BurnableImplInterface;
  ...
  removeAllListeners<TCEvent extends TypedContractEvent>(event?: TCEvent): Promise<this>
    ...
    initialize: TypedContractMethod<
      [collectionName: string, collectionSymbol: string, initialOwner: AddressLike, ],
      [void],
      'nonpayable'
    >
