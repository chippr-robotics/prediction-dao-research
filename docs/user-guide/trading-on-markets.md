...
- These are probability-style market prices (0 to 1), while trade settlement uses USDC and gas is paid in MATIC
...
- ✅ Connected wallet
- ✅ Sufficient USDC for trades + MATIC for gas fees
...
2. **Challenge Period**
   ...
   - Challengers post 150 MATIC bond
