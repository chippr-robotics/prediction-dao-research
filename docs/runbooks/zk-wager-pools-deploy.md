...
GAS_PRICE_WEI=30000000000 \
  npx hardhat run scripts/deploy/deploy-wager-pool-factory.js --network amoy
...
# Mordor (ETC testnet) — direct deploy (no Semaphore prerequisite; the redesign is address-based):
