...
While friend markets support optional arbitrators:
- **Arbitrators are chosen by you** - not vetted by FairWins
- Arbitrators may be biased, unavailable, or dishonest
- **No legal recourse** if arbitration goes wrong
- For important bets, consider using:
  - Public markets with established oracles
  - Pegged markets that settle based on public outcomes
  - Multiple trusted arbitrators
...
- [Smart Contract Basics](../smart-contracts.md)
- [Understanding Oracles](../oracles.md)
- [Market Pegging Guide](./market-pegging.md)
- [Ragequit Protection](../ragequit.md)
- [General Platform Safety](../safety.md)

**Questions?** Contact support@fairwins.app (but remember: we cannot reverse smart contracts!)
