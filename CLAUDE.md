...
- **Workstation credentials live in Secret Manager, never in `.env` (spec 088).** The machine the
  ...
  `infra/observability/README.md` + `specs/088-workstation-secrets-observability/`.
