...
///
/// (vendoring note: upstream carries an `@custom:storage-location
/// erc7201:coinbase.storage.MultiOwnable` annotation here; it is a
/// tooling-only NatSpec line with zero bytecode effect, removed because
/// @openzeppelin/hardhat-upgrades hard-errors on file-level namespaced
/// structs. See contracts/account/README.md.)
