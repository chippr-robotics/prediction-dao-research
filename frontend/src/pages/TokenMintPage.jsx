...
/**
 * Spec 028 — Token Mint page. Composes the create wizard, the issuer's network-scoped token list (→ admin
 * surface), and public discovery/browse (→ read-only detail). All real Web3, no mock data (Constitution III):
 * lists read the on-chain factory registry and the feature self-disables on networks without a deployed
 * factory (FR-023).
 */
