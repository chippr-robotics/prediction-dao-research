...
**AI output can be wrong, and it is not advice.** Anything the assistant tells you is generated text. It may be inaccurate, incomplete, out of date, or confidently wrong about a fee, a deadline, a balance, or a rule — **including when it has just read your own wagers, membership, or fee rates to answer you.** A read can be stale or can fail, and the assistant's summary of what it read is still generated text; a wager description or market name it reads was written by someone else and may contain text designed to mislead it. **Verify it before you sign anything.** It is not financial, legal, or tax advice, and it is not a substitute for reading what you are about to sign.

**The assistant never signs and never submits.** It cannot enter, accept, resolve, or claim a Wager, cannot spend or transfer your assets, and cannot act at any Trading Venue. Its reads of your data are read-only and it cannot move your screen or fill a form on your behalf. Every transaction is signed by you, in your own wallet. **Nothing in the Service will ever ask you for a private key, seed phrase, or recovery information** — if anything appears to, stop and do not provide it.

**If you run the assistant on your own GutterToken credit, that credit is GutterToken's to hold, not ours.** Credit you deposit with GutterToken is prepaid to GutterToken, is **non-refundable on GutterToken's terms**, and is spent per token at rates GutterToken sets and may change; FairWins cannot see your balance, cannot stop a charge, and cannot recover credit that is spent, lost, or stranded. **A GutterToken account opened with a wallet alone, and no e-mail, cannot be recovered by anyone if you lose that wallet's key** — the credit in it is lost with it. The key you enter is stored on this device only: anyone who obtains it can spend your GutterToken credit until you revoke it at GutterToken, and it is not part of your FairWins backup, so a new device starts without it. GutterToken may be unavailable, may rate-limit your network, or may cease operating, and FairWins has no control over any of that.
