...
// Promoted to lib/wagers/displayTitle.js so non-component layers (the account
// activity ledger) can share the exact title logic; re-exported here so
// component imports are unchanged.
export { isOpenChallengeMarket, getMarketDisplayTitle } from '../../lib/wagers/displayTitle'
